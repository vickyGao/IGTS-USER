  ...
  $.danidemo = $.extend( {}, {
    ...
    addFile: function(id, i, file){
		var template = '<div id="demo-file' + i + '">' +
		                   ...
		                   '<span class="demo-file-id">#' + i + '</span> - ' + file.name + ' <span class="demo-file-size">(' + $.danidemo.humanizeSize(file.size) + ')</span><br />状态： <span class="demo-file-status">Waiting to upload</span>'+
